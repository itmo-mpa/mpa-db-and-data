...
INSERT INTO state (id, name, description, disease_id) VALUES (7, 'HS4', 'Стационарный этап, среднетяжелое обострение (нарастание симптоматики, ПСВ < 60%, 2 < 90%.)', 1);
INSERT INTO state (id, name, description, disease_id) VALUES (8, 'HS5', 'Стационарный этап лечения, неполный ответ (ПСВ = 50–70%, 2 < 90%)', 1);
