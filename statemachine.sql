...
insert into attribute_values(attribute_id, value) values (5, 'positive');
insert into attribute_values(attribute_id, value) values (5, 'negative');
insert into attribute_values(attribute_id, value) values (5, 'uncertain');
insert into attribute_values(attribute_id, value) values (6, 'positive');
insert into attribute_values(attribute_id, value) values (6, 'negative');
insert into attribute_values(attribute_id, value) values (7, 'positive');
insert into attribute_values(attribute_id, value) values (7, 'negative');
insert into attribute_values(attribute_id, value) values (10, 'positive');
insert into attribute_values(attribute_id, value) values (10, 'negative');
insert into attribute_values(attribute_id, value) values (11, 'positive');
insert into attribute_values(attribute_id, value) values (11, 'negative');
insert into attribute_values(attribute_id, value) values (12, 'indicated');
insert into attribute_values(attribute_id, value) values (12, 'not indicated');
insert into attribute_values(attribute_id, value) values (13, 'indicated');
insert into attribute_values(attribute_id, value) values (13, 'not indicated');
insert into attribute_values(attribute_id, value) values (14, 'positive');
insert into attribute_values(attribute_id, value) values (14, 'negative');
insert into attribute_values(attribute_id, value) values (15, 'positive');
insert into attribute_values(attribute_id, value) values (15, 'negative');
...
insert into transition(id, state_from_id, state_to_id, predicate) values (3, 10, 12, 'eq ({status.5}, “positive”)');
insert into transition(id, state_from_id, state_to_id, predicate) values (4, 10, 11, 'eq ({status.5}, “uncertain”)');
insert into transition(id, state_from_id, state_to_id, predicate) values (5, 11, 12, 'eq ({status.6}, “positive”)');
insert into transition(id, state_from_id, state_to_id, predicate) values (6, 12, 13, 'eq ({status.7}, “positive”)');
insert into transition(id, state_from_id, state_to_id, predicate) values (7, 12, 17, 'and (eq ({status.7, “negative”}), eq ({status.8}, true))');
insert into transition(id, state_from_id, state_to_id, predicate) values (8, 12, 17, 'and (eq ({status.7, “negative”}), eq ({status.9}, true))');
insert into transition(id, state_from_id, state_to_id, predicate) values (10, 13, 14, 'eq ({status.10}, “positive”)');
insert into transition(id, state_from_id, state_to_id, predicate) values (11, 13, 17, 'and (eq ({status.10, “negative”}), eq ({status.8}, true))');
insert into transition(id, state_from_id, state_to_id, predicate) values (12, 13, 17, 'and (eq ({status.10, “negative”}), eq ({status.9}, true))');
insert into transition(id, state_from_id, state_to_id, predicate) values (13, 15, 3, 'eq ({status.11}, “positive”)');
insert into transition(id, state_from_id, state_to_id, predicate) values (14, 15, 16, 'and (eq ({status.11, “negative”}), eq ({status.9}, true))');
insert into transition(id, state_from_id, state_to_id, predicate) values (15, 15, 17, 'and (eq ({status.11, “negative”}), eq ({status.8}, true))');
insert into transition(id, state_from_id, state_to_id, predicate) values (16, 16, 13, 'eq ({status.12}, “indicated”)');
insert into transition(id, state_from_id, state_to_id, predicate) values (17, 16, 4, 'eq ({status.12}, “not indicated”)');
insert into transition(id, state_from_id, state_to_id, predicate) values (18, 17, 4, 'eq ({status.13}, “not indicated”)');
insert into transition(id, state_from_id, state_to_id, predicate) values (19, 17, 18, 'eq ({status.13}, “indicated”)');
insert into transition(id, state_from_id, state_to_id, predicate) values (22, 18, 5, 'eq ({status.14}, “negative”)');
insert into transition(id, state_from_id, state_to_id, predicate) values (23, 18, 19, 'eq ({status.14}, “positive”)');
insert into transition(id, state_from_id, state_to_id, predicate) values (24, 19, 5, 'eq ({status.15}, “negative”)');
insert into transition(id, state_from_id, state_to_id, predicate) values (25, 19, 6, 'eq ({status.15}, “positive”)');
...
insert into transition(id, state_from_id, state_to_id, predicate) values (28, 10, 2, 'eq ({status.5}, “negative”)');
insert into transition(id, state_from_id, state_to_id, predicate) values (29, 11, 2, 'eq ({status.6}, “negative”)');
